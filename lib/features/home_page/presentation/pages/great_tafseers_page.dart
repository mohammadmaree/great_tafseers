  ...
  Widget build(BuildContext context) {
    ...
    return BlocBuilder<HomePageBloc, HomePageState>(
     builder: (context, state) {
       if(state is ChangePageViewIndexStateLoaded)
         {
           return Scaffold(
             body: SafeArea(
               child: Stack(
                 children: [
                     ...
                     child: PageView.builder(
                       ...
                       itemBuilder:(context, index) =>
                           BuildPageView(
                             ...
                             page:state.homePage.imageOfSora,
                             //page: pages[index],
                           ),
                       itemCount: 4,
                       onPageChanged:(index){
                   ...
                   Positioned(
                     ...
                     child: BuildDefaultImage(
                       image:state.homePage.numberOfJoza,
                       //image: jozaNumber,
                   ...
                   Positioned(
                     ...
                     child: BuildDefaultImage(
                       image:state.homePage.nameOfSora,
                       //image: soraName,
                       screenWidth:screenWidth!*0.14,
                       screenHeight:screenHeight!*0.034,
                     ),
                   ...
                   Positioned(
                     ...
                     child: BuildDefaultText(
                       color:0xFF000000,
                       text: state.homePage.numberOfPage,
                       //text: pageNumber,
         ...
         }else if(state is ChangePageViewIndexStateError){
         return const Center(child: Text('error'),);
       }else if(state is ChangePageViewIndexStateLoading){
